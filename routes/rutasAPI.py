...
from models.chatbot import chat  # Asegúrate de que estás importando la tabla correctamente
from database.basedatos import conexion  # Importa la conexión que has definido
